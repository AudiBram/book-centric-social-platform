...
import org.project.bookcentricapi.security.JwtService;
...
public class AuthenticationService {
    ...
    public void activateAccount(String token) throws MessagingException {
        ...
        if (LocalDateTime.now().isAfter(savedToken.getExpiresAt())) {
            ...
            throw new RuntimeException("Activation token has ben expired. A new token has been sent to the same email");
        }
